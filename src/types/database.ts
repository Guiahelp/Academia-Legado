// ============================================
// TIPOS DEL DOMINIO - Tribu Legado
// ============================================

export type UserRole = 'client' | 'entrepreneur' | 'admin'
...
export interface Profile {
  ...
  created_at: string
  updated_at: string
  // Datos Memoria IA (Contrato Psicológico)
  meta_financiera?: string | null
  compromiso_tiempo?: string | null
  sacrificio?: string | null
  // Progreso de Gamificación WebApp
  current_academy_level?: number
}
...
export interface Appointment {
  ...
  entrepreneur?: Entrepreneur & { profile: Profile }
...
export interface EntrepreneurWithProfile extends Entrepreneur {
  profile: Profile
  availability?: Availability[]
}

export interface AppointmentWithRelations extends Omit<Appointment, 'client' | 'entrepreneur' | 'appointment_type'> {
...
export interface ProjectWithRelations extends Omit<Project, 'entrepreneur' | 'client'> {
  entrepreneur: Entrepreneur & { profile: Profile }
  client: (Client & { profile?: Profile | null }) | null
}
