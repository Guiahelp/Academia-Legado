...
import { useEntrepreneurAvailability } from '../hooks/useAvailability'
...
export function AvailabilityGrid({ entrepreneurId }: AvailabilityGridProps) {
  const { availability, loading, error } = useEntrepreneurAvailability(entrepreneurId)
