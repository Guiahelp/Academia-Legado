...
export const availabilityService = {
  /**
   * Obtiene slots disponibles para un empresario en una fecha específica
   * Considera: availability + citas ya agendadas
   */
  async getAvailableSlots(entrepreneurId: string, date: Date): Promise<string[]> {
  ...
  async getEntrepreneurAvailability(entrepreneurId: string) {
    const supabase = createClient()
