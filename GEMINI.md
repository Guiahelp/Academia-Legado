...
## 👤 Perfil del Usuario y Reglas de Comunicación
- **Idioma**: SIEMPRE hablar en **español**.
- **Nivel Técnico**: Cero (0). El usuario es un **creador y aterrizador de ideas**, no un programador.
- **Estilo**: Explicaciones claras, analogías sencillas, evitar tecnicismos innecesarios. Si se nombra una tecnología, explicar "para qué sirve" en términos de negocio/idea.
- **Canal Maestro**: WhatsApp es la prioridad #1. El correo es secundario o inexistente.
- **Modelo de Negocio**: Economía colaborativa (Sistema Matricial / Tableros) con entrada de $50 USD. Enfoque en formación para **Empresarios y Emprendedores**.
- **Formato**: Estructurado, visual y orientado a resultados.
...
| **Master Vision** | El Norte del Negocio y Arquitectura | `VISION_MAESTRA.md` |
...
| Comunicación | WhatsApp | Contacto directo y cierre de ventas |
| Economía | Smart Contract / Matrix | Sistema de tableros de economía colaborativa |

**Ejemplo:**
- Humano: "Necesito que la gente se una a la matriz" (QUÉ)
- Tú: Implementas un formulario que captura datos y redirige a WhatsApp con un mensaje pre-armado (CÓMO)
...
## 🛡️ Estrategia de Cumplimiento (Anti-Baneo)
- **Concepto**: La WebApp se presenta como una **Academia de Educación** para evitar bloqueos de algoritmos (Meta/Google).
- **Metadata**: Usar términos como "Educación tecnológica", "Comunidad Web3", "Herramientas digitales".
- **Evitar**: Promesas de dinero fácil o términos financieros agresivos en la landing page principal.
- **Agentes**: Albert y Nikola son los guías que filtran y educan antes de mostrar el sistema de ganancias.
...
### 2026-02-20: Pivot a Academia de Empresarios
- **Error**: Uso del término "abogados" heredado del template.
- **Fix**: Reemplazar globalmente por "Empresarios/Emprendedores". Centrar la propuesta en la "Guía del Éxito" para multinivel/redes.
