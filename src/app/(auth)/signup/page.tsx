  ...
  return (
    <div className="space-y-8">
      ...
      <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
        ...
        <span className="text-xl font-bold text-primary-500">Tribu Legado</span>
      </div>

      <div className="text-center lg:text-left">
        <h1 className="text-display-xs text-foreground">Crea tu cuenta</h1>
        <p className="mt-2 text-foreground-secondary">Únete hoy y comienza tu camino a la soberanía financiera</p>
      </div>
