        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="mb-8">
            ...
            <h1 className="text-display-md text-white mb-4">
              Domina la tecnología y alcanza tu libertad
            </h1>
            <p className="text-lg text-white/70 leading-relaxed">
              La plataforma de educación diseñada para empresarios dispuestos a romper el sistema y heredar un legado real.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-white/80">
              ...
              <span>Formación en Blockchain, IA y Criptomonedas</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Guía del Éxito 2026 paso a paso</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Comunidad de apoyo y economía colaborativa</span>
            </div>
          </div>
        </div>
